 ...
 * 
 * @description    Página de visualización de las reservas del usuario
 * 
 ******************************************************************************/
...
const ManageMyReservations = () => {
  ...
  const fetchReservations = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${baseUrl}/api/reservation/myreservations/${localStorage.getItem('id')}`, {
  ...
  return (
    <div className="container mt-3">
      <h2 className="text-center text-decoration-underline mb-4">Mis Reservas</h2>
...
export default ManageMyReservations;
